...
public class PDFDocument extends AbstractPdfView {
    ...
    protected void buildPdfDocument(
        ...
        //Get data from model
        List<Applications> applicationsList = (List<Applications>) model.get("modelObject");
        for (Applications applications : applicationsList) {
            table.addCell(applications.getOrganizations());
            table.addCell(applications.getSystem_name());
